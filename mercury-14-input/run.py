...
LOCAL_CORES = 4 # number of cores to use on a local computer
...
#                    break
            ...
            if cycle > 0:
                ...
                th = fis[-D.info['feat_num']*(100-cycle*11)/100]
                #print th
                which = fi > th
                #print which
...
#                vprint( verbose,  "[+] SVM croos_val done! Mean = %0.2f" % (scores.mean()))
            ...
            if best_cycle > 0:
                                #th = fis[- D.info['feat_num'] / 10]# we can choose it with brain!
                th = fis[-D.info['feat_num']*(100-best_cycle*11)/100]
                #print th
                which = fi > th
                #print which
