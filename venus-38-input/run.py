...
if __name__=="__main__" and debug_mode<4:	
    ...
    for basename in datanames: # Loop over datasets
        ...
        if basename=='jasmine':
            ...
            Y_valid, Y_test = learning_routine.process_jasmine(D.data['X_train'], D.data['Y_train'], D.data['X_valid'], D.data['X_test'])
        elif basename=='christine':
            print('process christine')
            Y_valid, Y_test = learning_routine.process_christine(D.data['X_train'], D.data['Y_train'], D.data['X_valid'], D.data['X_test'])
        elif basename=='sylvine':
            print('process sylvine')
            Y_valid, Y_test = learning_routine.process_sylvine(D.data['X_train'], D.data['Y_train'], D.data['X_valid'], D.data['X_test'])    
        elif basename=='madeline':
            print('process madelinr')
            Y_valid, Y_test = learning_routine.process_madeline(D.data['X_train'], D.data['Y_train'], D.data['X_valid'], D.data['X_test'])    
        elif basename=='philippine':
            print('process philippine')
            Y_valid, Y_test = learning_routine.process_philippine(D.data['X_train'], D.data['Y_train'], D.data['X_valid'], D.data['X_test'])    
        else:
