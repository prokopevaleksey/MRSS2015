...
global_params = {}
global_params['n_jobs'] = -1 # number of cores to use on a local machine
global_params['n_folds'] = 10 # number of cross-validation splits
...
if __name__=="__main__" and debug_mode<4:	
    ...
    for basename in datanames: # Loop over datasets
        ...
        #Do learning here
        if basename=='jasmine':
            print('process my_jasmine')
            Y_valid, Y_test = learning_routine.process_my_jasmine(D.data['X_train'], D.data['Y_train'], D.data['X_valid'], D.data['X_test'], global_params)
        elif basename=='christine':
